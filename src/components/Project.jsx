...
const Project = ({ data }) => {
  ...
  return (
    <div className="flex flex-col border rounded-3xl border-gray-700 text-secondary">
      {/* Header */}
      <div className="mx-3 pt-3 pb-2 px-1">
      ...
      {/* techStack */}
      <div className=" p-4 flex flex-wrap gap-2 mt-4">
        {techstack.map((tag, index) => (
          <span
            key={index}
            className="px-2 py-1 text-lg  rounded-md border border-gray-700 "
          >
            {tag}
          </span>
        ))}
      ...
      {/* Description */}
      <div className="p-4">
        <h5 className="mb-2 text-xl text-secondary font-semibold">
          Description
        </h5>
        <p className="leading-normal text-secondary">{summary}</p>
      </div>
            ...
            <>
              ...
              <ModalFooter className="bg-primary">
                <a
                  ...
                  className="flex items-center gap-2 px-3 py-2 border border-gray-700 rounded hover:bg-gray-800 transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
